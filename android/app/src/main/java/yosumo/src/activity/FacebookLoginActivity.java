...
public class FacebookLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        deAuthButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (!isLoggedIn()) {
                    Toast.makeText(FacebookLoginActivity.this, "No registrado", Toast.LENGTH_LONG).show();
                    return;
                }
                    ...
                    public void onCompleted(GraphResponse response) {
                        try {
                            if (response.getError() != null) {
                                Toast.makeText(FacebookLoginActivity.this, "Error de autenticacion", Toast.LENGTH_LONG).show();
        ...
        fbLoginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(final LoginResult loginResult) {
                // App code
                Toast.makeText(FacebookLoginActivity.this, "Se incio", Toast.LENGTH_LONG).show();
                updateUI();
            }
            ...
            public void onCancel() {
                // App code
                Toast.makeText(FacebookLoginActivity.this, "Cancelar", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onError(final FacebookException exception) {
                // App code
                Log.d("Error ", "Error " + exception.toString());
                Toast.makeText(FacebookLoginActivity.this, "Error" + exception.toString(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void updateUI() {
        ...
        if (profile != null) {
            ...
            Log.d("profilePictureView h", " " + profilePictureView.getHeight());
            Log.d("profilePictureView w", " " + profilePictureView.getWidth());


            //profilePictureView.setMinimumWidth(153);
